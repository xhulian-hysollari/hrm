            ...
            <div class="custom-panel">
                ...
                <div class="form-group">
                    <div class="col-sm-6 col-sm-offset-3">
                        <a href="{{route('pim.employees.documents.index', Route::input('employeeId'))}}"
                    ...
                    <form method="get" class="row" id="date_filter" action="">
                        <div class="col-md-3">
                            <input type="date" class="form-control" name="date_start"
                                   placeholder="{{trans('app.time.time_logs.start_date')}}"
                                   value="{{$request->date_start}}" required/>
                        </div>
                        <div class="col-md-3">
                            <input type="date" class="form-control" name="date_end"
                                   placeholder="{{trans('app.time.time_logs.end_date')}}" value="{{$request->date_end}}"
                                   required/>
                        </div>
                        <div class="col-md-3">
                            <button type="submit" class="btn btn-primary"
                                    style="margin-top: 0">{{trans('app.filter')}}</button>
                        </div>
                    </form>
                </div>
