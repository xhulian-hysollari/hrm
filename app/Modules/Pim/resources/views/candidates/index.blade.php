...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <a href="{{route('pim.candidates.create')}}"
               class="btn btn-primary pull-right">{{trans('app.pim.candidates.add_new')}}</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="custom-panel">
                ...
                {!! Form::open(['route' => ['pim.candidates.upload'], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
